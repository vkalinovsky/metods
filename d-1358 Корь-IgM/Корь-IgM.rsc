...
; UnicodeOption
; default: NoDefault
text=Измерить оптическую плотность с помощью спектрофотометра в двухволновом режиме:\nосновной фильтр - 450 нм, референс-фильтр - в диапазоне 620-655 нм. Допускается измерение только с фильтром 450 нм. Время между остановкой реакции и измерением оптической плотности не должно превышать 5 мин.
; TechProcess step duration
; TimeOption
; default: 0
duration=
