...
; UnicodeOption
; default: None
name=IgA к Helicobacter pylori
; Producer
; UnicodeOption
; default: None
producer=ЭКОлаб
...
; CellList
; default: []
A=Blank S09 S17 S25 S33 S41 S49 S57 S65 S73 S81 S89
; CellList
; default: []
B=Kplus S10 S18 S26 S34 S42 S50 S58 S66 S74 S82 S90
; CellList
; default: []
C=Kplus_1 S11 S19 S27 S35 S43 S51 S59 S67 S75 S83 S91
; CellList
; default: []
D=Kminus S12 S20 S28 S36 S44 S52 S60 S68 S76 S84 S92
; CellList
; default: []
...
; UnicodeOption
; default: NoDefault
text=Извлечь из упаковки рамку планшета и необходимое число стрипов. Неиспользованные стрипы допускается хранить в плотно закрытом пакете с влагопогпотителем при температуре от 2 до 8 СС до истечения срока годности
...
; UnicodeOption
; default: NoDefault
text=Планшет закрыть крышкой или клейкой пленкой. Инкубировать 30 мин при температуре от 21 до 25 С в защищенном от света месте.
; TechProcess step duration
; TimeOption
; default: 0
duration=30m
...
; UnicodeOption
; default: NoDefault
text=С помощью промывателя удалить образцы из лунок. 4 раза промыть планшет промывочным раствором, внося в лунки 350-370 мкл раствора При наличии промывателя, позволяющего производить промывку в режиме 'Overflow", использовать именно этот режим. По окончании промывки остатки раствора удалить из лунок, постукивая перевернутым планшетом по сложенной в несколько слоев фильтровальной бумаге.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text= Во все лунки внести по 100 мкл раствора индикаторного, немедленно поместить планшет 8 защищенное от света место и инкубировать 10 мин при температуре от 21 до 25°С.
; TechProcess step duration
; TimeOption
; default: 0
duration=10m
...
; UnicodeOption
; default: NoDefault
text=Во все лунки (в той же последовательности, с которой вносился субстратно индикаторный раствор) внести по 100 мкл стоп-реагента, осторожно (постукиванием по планшету) перемешать содержимое лунок и не более чем через 10 мин приступить к учету результатов.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; StringOption
; default: NoDefault
formula=ODMeans[key] > 1,1*Kplus_1
