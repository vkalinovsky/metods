...
; UnicodeOption
; default: None
name=Ротавирус-антиген ВОДА, КУЛЬТ. ЖИДКОСТЬ
; Producer
; UnicodeOption
; default: None
...
; UnicodeOption
; default: NoDefault
text=Внести контрольные образцы:\n• 1 лунка - 100 мкл К+;\n• 2 лунки - по 100 мкл К~\nНапример, в лунки А-1 и В-1 внести по 100 мкл К-, в лунку С-1 внести 100 мкл К+. Во все остальные лунки внести по 100 мкл подготовленных исследуемых образцов (п. 5.2.).\nВремя внесения образцов не должно превышать 10 мин при использовании всех лунок планшета.\n
...
; UnicodeOption
; default: NoDefault
text=Планшет заклеить пленкой и инкубировать в термостате в течение 60 мин при температуре 37°С.
; TechProcess step duration
; TimeOption
; default: 0
duration=1h
...
; UnicodeOption
; default: NoDefault
text=В лунки планшета внести по 100 мкл конъюгата.\nДля внесения коньюгата использовать пластиковую ванночку и одноразовые наконечники, ходящие в состав набора.\n
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text=Измерить величину оггпгческой плотности растворов в лунках стрипов на спектрофотометре\nвертикального сканирования в двухволновом режиме при основной длине волны 450 нм и длине волны сравнения в диапазоне 620-655 нм; или при одной длине волны — 450 нм.\nВремя между остановкой реакции и измерением оптической плотности не должно превышать 5 мин.\n
; TechProcess step duration
; TimeOption
; default: 0
duration=
