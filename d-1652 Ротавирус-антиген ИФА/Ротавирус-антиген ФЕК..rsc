...
; UnicodeOption
; default: NoDefault
text=Внести контрольные образцы:\n• 1 лунка - 100 мкл К+;\n• 2 лунки - по 100 мкл К~.\nНапример, в лунки А-1 и В-1 внести по 100 мкл К-, в лунку С-1 внести 100 мкл К+. Во все остальные лунки внести по 100 мклподготовленных исследуемых образцов.\nВремя внесения образцов не должно превышать 10 мин при использовании всех лунок\nпланшета.
...
; UnicodeOption
; default: NoDefault
title=2. Внесение коньюгата
; TechProcess step description
; UnicodeOption
; default: NoDefault
text=В лунки планшета внести по 100 мкл коньюгата.\nДля внесения коньюгата использоватьпластиковую ванночку и одноразовые наконечники, входящие в состав набора.\n
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text=По окончании инкубации снять липкую пленку и поместить ее в сосуд с дезинфицирующим раствором. С помощью промывочного устройства промыть лунки планшета 5 раз промывочным раствором, чередуя аспирацию и немедленное заполнение лунок каждого стрипа. В каждую лунку вносить не менее 400 мкл жидкости в процессе каждого цикла промывки. Время между заполнением и опорожнением лунок должно быть не менее 30 сек. Необходимо добиваться\nполного опорожнения лунок после каждого их заполнения. По окончании промывки остатки\nвлаги из лунок тщательно удалить, постукивая перевернутым планшетом по фильтровальной бумаге.\n\nВнимание! Промывку при помощи автоматического промывателя рекомендуется проводить в режиме с переполнением («Overflow») с 5-ю циклами промывки и внесением в лунки по 600-700 мкл рабочего промывочного раствора. При этом следует использовать поперечную аспирацию раствора из лунок (режим «Crosswise»), чтобы остаточный объем не превышал 10 мкл.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text=Планшет выдержать в защищенном от светаместе в течение 25 мин при температуре 18—25°С.
; TechProcess step duration
; TimeOption
; default: 0
duration=25m
...
; UnicodeOption
; default: NoDefault
title=7. Внесение стоп-реагента
; TechProcess step description
; UnicodeOption
; default: NoDefault
text=Внести во все лунки по 100 мкл стопреагента с той же скоростью и в той же последовательности, как и раствор тетраметилбензидина. Краткая схема проведения ИФА приведена в приложении 1 в конце настоящей инструкции.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
title=8. Проведение измерений
; TechProcess step description
; UnicodeOption
; default: NoDefault
text=Измерить оптическую плотность с помощью спектрофотометра в двухволновом режиме: основной фильтр - 450 нм, референс-фильтр - в диапазоне 620-655 нм. Допускается измерение только с фильтром 450 нм.\n\nВремя между остановкой реакции и измерением оптической плотности не должно превышать 5 мин.\n
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; CommaStringList
; default: []
groups=_RESULT_GROUP_1, _RESULT_GROUP_2, _RESULT_GROUP_3, _RESULT_GROUP_4
; Recalculate titers
; BoolOption
; default: False
