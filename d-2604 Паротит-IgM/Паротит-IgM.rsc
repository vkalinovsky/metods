...
; UnicodeOption
; default: NoDefault
text=В лунки планшета внести по 100 мкл рабочего раствора конъюгата.\nДля внесения рабочего раствора коньюгата использовать пластиковую ванночку и одноразовые наконечники, входящие в состав набора.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text=По окончании инкубации промыть планшет как описано выше.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; UnicodeOption
; default: NoDefault
text=Внести во все лунки по 100 мкл стоп-реагента с той же скоростью и в той же последовательности, как и рабочий раствор тетраметилбензидина.
; TechProcess step duration
; TimeOption
; default: 0
duration=
...
; StringOption
; default: NoDefault
formula=0.8*ODcrit < ODMeans < ODcrit
; Text to display if the var is True
; UnicodeOption
; default: 
text=неопределенный
